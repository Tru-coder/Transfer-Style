...
def image_loader(image_name, desired_width, desired_height, loader, device):
...
def run_style_transfer(cnn, normalization_mean, normalization_std,
    ...
    while run[0] <= num_steps:
        ...
        def closure():
            ...
            if run[0] % sample_step == 0:
                torchvision.utils.save_image(input_img, output_path +
                                             "\\" + 'LBFGS-combined-output-{}.jpg'.format(run[0] + 1))
...
#
def style_transfer_gatys_one_style_lbfgs(content_img_path, style_img_path_1, output_path, device,
                                         desired_size, style_weight):
    ...
    style_img = image_loader(style_img_path_1, desired_size, desired_size, loader, device)
    content_img = image_loader(content_img_path, desired_size, desired_size, loader, device)

    print('Style image size is {}'.format(style_img.size()))
    print('Content image size is {}'.format(content_img.size()))
    ...
    output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                                content_img, style_img, input_img, output_path)
    torchvision.utils.save_image(input_img, output_path +
                                 "\\" + "lbfgs-result.jpg")
    # plt.figure()
